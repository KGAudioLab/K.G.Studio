...
export const zhHkMessages: TranslationMessages = {
  ...
  'dialog.title.convertChordsToMidi': '將和弦轉換為 MIDI',
  'dialog.chordToMidi.methodLabel': '和弦轉 MIDI 的轉換方式',
  'dialog.chordToMidi.createRegion': '建立新的 MIDI 片段',
  'dialog.chordToMidi.addToRegion': '將音符加入現有片段',
  'dialog.chordToMidi.replaceInRegion': '取代現有片段中的音符',
  ...
  'toolbar.snap.off': '關閉',
  'toolbar.snap.bar': '吸附到小節',
  'toolbar.snap.beat': '吸附到節拍',
