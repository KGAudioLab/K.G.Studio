...
export const zhHkMessages: TranslationMessages = {
  ...
  'settings.sidebar.close': '關閉設置',
  'settings.sidebar.general': '通用',
  'settings.sidebar.audioIo': '音頻 I/O',
  ...
  'settings.general.language.help': '自動會使用你的系統語言。',
  'settings.general.language.auto': '自動',
  'settings.yes': '是',
  'settings.no': '否',
  'settings.restoreDefault': '恢復默認',
  ...
  'settings.general.persistKeys.help': '啟用後，即使在非 localhost 環境下，API Key 也會保存到瀏覽器存儲中。警告：這可能增加 XSS 攻擊帶來的安全風險。',
  ...
  'settings.general.localRuntime.autoDownload': '下次你使用 `Local LLM (Browser)` 聊天時，本地模型會自動下載。',
  ...
  'settings.general.openai.keyPlaceholder': '輸入你的 OpenAI API Key',
  ...
  'settings.general.keys.persisted': '密鑰會保存在本地（瀏覽器中的 IndexedDB）。',
  ...
  'settings.general.claudeOpenRouter.keyPlaceholder': '輸入你的 Claude API Key',
  'settings.general.baseUrl': '基礎 URL',
  'settings.general.claudeOpenRouter.baseUrlHelp': '這是 OpenRouter API 的基礎 URL。除非你明確知道自己在做什麼，否則不要修改。',
  'settings.general.openaiCompatible.section': 'OpenAI 兼容服務',
  'settings.general.openaiCompatible.keyPlaceholder': '輸入你的 API Key',
  ...
  'settings.general.soundfont.section': 'Soundfont 設置',
  'settings.general.soundfont.managed': 'Soundfont 配置由服務器（kgone-server.json）管理，當前設置為只讀。',
  'settings.general.soundfont.baseUrl': '基礎 URL',
  'settings.general.soundfont.baseUrlHelp': '如果改成不兼容的 soundfont 源，某些樂器可能發聲錯誤或無法播放。',
  'settings.general.kgone.section': 'K.G.One 設置',
  'settings.general.kgone.managed': 'K.G.One 配置由服務器（kgone-server.json）管理，當前設置為只讀。',
  'settings.general.kgone.enabled': '啟用 K.G.One 集成',
  'settings.general.kgone.disabled': '禁用',
  'settings.general.kgone.enabledOption': '啟用',
  'settings.general.kgone.serverBaseUrl': '服務器基礎 URL',
  'settings.general.kgone.serverBaseUrlHelp': '正在運行的 K.G.One Music Studio 服務器基礎 URL。用於整曲生成、片段生成和分軌。',
  'settings.audioIo.title': '音頻 I/O',
  'settings.audioIo.deviceRouting': '裝置路由',
  'settings.audioIo.refresh': '重新整理裝置清單',
  'settings.audioIo.refreshing': '重新整理中…',
  'settings.audioIo.description': '選擇 KGStudio 用於錄音與播放的裝置。輸入裝置的變更會在下一次錄音時生效。輸出裝置的變更在 v1 中需要重新整理頁面後生效。',
  'settings.audioIo.inputDevice': '音頻輸入裝置',
  'settings.audioIo.outputDevice': '音頻輸出裝置',
  'settings.audioIo.inputHelp': '變更會在下一次錄音時生效。如果所選裝置被移除，KGStudio 會回退到系統預設裝置。',
  'settings.audioIo.outputHelp': '在 v1 中，輸出裝置變更需要重新整理頁面。瀏覽器對非預設輸出路由的支援有限，因此在不支援時 KGStudio 會繼續使用系統預設裝置。',
  ...
  'settings.audioIo.status.inputUnavailable': '先前選擇的音頻輸入裝置不可用；將使用系統預設裝置。',
  'settings.audioIo.status.outputUnavailable': '先前選擇的音頻輸出裝置不可用；將使用系統預設裝置。',
  'settings.audioIo.status.refreshed': '音頻裝置清單已重新整理。',
  'settings.audioIo.status.readFailed': '無法從瀏覽器讀取音頻裝置。',
  'settings.audioIo.status.inputDefaultNextSession': '音頻輸入將在下一次錄音時使用系統預設裝置。',
  'settings.audioIo.status.inputChangedNextSession': '音頻輸入將在下一次錄音時切換。',
  'settings.audioIo.status.outputDefaultAfterRefresh': '重新整理後音頻輸出將使用系統預設裝置。',
  'settings.audioIo.status.outputSavedRefreshRequired': '音頻輸出裝置已儲存。在 v1 中請重新整理頁面以套用。',
  'settings.audioIo.status.outputPromptUnsupported': '此瀏覽器不支援彈出音頻輸出裝置選擇。',
  'settings.audioIo.status.outputSelectedRefreshRequired': '已選擇輸出裝置。請重新整理頁面以在 v1 中套用。',
  ...
  'settings.behavior.audio': '音頻',
  'settings.behavior.lookaheadTime': '前瞻時間（ms）',
  'settings.behavior.lookaheadTimeHelp': '音頻排程前瞻時間（0-500ms）。較低的值（10-20ms）可降低 MIDI 輸入延遲，但在較慢的系統上可能造成音頻卡頓。較高的值（100ms 以上）更有利於播放穩定性。變更會立即生效，無需重新啟動。',
  ...
  'settings.behavior.midiInputLatencyHelp': '用於 MIDI 錄音的時間校正（0-500ms）。如果錄下來的音符比你實際想演奏的位置略晚，可以增加此值以匹配你的 MIDI 裝置輸入延遲。每個音符在提交時都會向前回移這段時間。',
  'settings.behavior.bounceStartsFromBeat1': '匯出從第 1 拍開始',
  'settings.behavior.bounceStartsFromBeat1Help': '選擇「是」時，匯出 WAV/MP3 會包含從歌曲開頭到第一個被渲染區域之前的前導靜音。選擇「否」時，會裁掉這段前導靜音，並從第一個被渲染的音符或音頻區域開始匯出。',
  'settings.behavior.captureAudioForScreenSharing': '為螢幕分享擷取音頻',
  'settings.behavior.captureAudioForScreenSharingHelp': '需要重新啟動 KGStudio（重新整理頁面）後生效。當在視訊會議中分享螢幕時，如果 KGStudio 的音頻無法被擷取，請啟用此選項（例如 Zoom、Teams）。這會建立一個額外的音頻串流，供螢幕擷取應用程式偵測。',
  ...
  'settings.templates.placeholder': '請輸入你為 K.G.Studio 音樂創作助手準備的自訂指示',
  ...
  'dialog.chordHint.audio': '和弦分析仍屬實驗性功能。和聲內容、編配密度以及瞬態較強的素材都可能影響準確率。建議先使用默認設置，再逐步微調靈敏度和穩定性，讓檢測結果更貼近實際樂句。',
  'dialog.chordHint.midi': '和弦分析仍屬實驗性功能。和弦堆疊密度、重疊以及裝飾音都會影響結果。建議先使用默認設置，再調整短音抑制和和聲關注方式，以匹配該段音樂的和聲作用。',
  'dialog.chordHint.tempo': '速度分析仍屬實驗性功能。自由速度、瞬態稀疏以及多層打擊樂都可能降低準確率。建議先使用默認 BPM 範圍，如果第一次結果不理想，再把分析範圍收窄到更可能的速度區間。',
  'dialog.sourceHint.kgone': '為了獲得更可靠的和弦標籤，建議分析已經削弱或移除了人聲和打擊樂的 stem。如果已啟用 K.G.One Music Studio 服務器集成，請使用帶有 "Vocal, Drums, Bass, Guitar, Piano, and Others" 的 Separator 模型，並優先分析 Piano 或 Others stem。',
  'dialog.sourceHint.local': '為了獲得更可靠的和弦標籤，建議分析已經削弱或移除了人聲和打擊樂的 stem。如果你使用本地分軌器，請選擇 "Vocal, Drums, Bass, and Others" 模型，並使用 Others stem 進行分析。',
  ...
  'dialog.message.chordDetection': '在處理前調整音頻和弦檢測設置。',
  'dialog.message.tempoDetection': '在處理前調整音頻速度檢測設置。',
  'dialog.message.tempoApply': '檢測到速度：{bpm} BPM。請選擇應用方式。\n\n"更新當前速度"將修改此片段位置的有效速度。"插入速度變更"將在片段起始點前最近的小節處添加新的速度區域。',
  ...
  'eventList.region.empty': '請選擇一個 MIDI 區域，或先在鋼琴卷簾中打開一個區域，再查看事件列表。',
  'eventList.region.add.label': '添加',
  'eventList.region.add.noteTitle': '在播放頭位置添加音符',
  'eventList.region.add.pitchBendTitle': '在播放頭位置添加彎音',
  'eventList.region.add.controllerTitle': '在播放頭位置添加控制器事件',
  ...
  'eventList.track.add.midiRegionTitle': '在播放頭位置添加 MIDI 區域',
  'eventList.track.add.volumeTitle': '在播放頭位置添加音量自動化點',
  'eventList.track.add.panTitle': '在播放頭位置添加聲像自動化點',
  'eventList.track.addType.midiRegion': 'MIDI 區域',
  'eventList.track.status.audio': '音頻',
  'eventList.track.status.midi': 'MIDI',
  'eventList.track.status.volume': '音量',
  'eventList.track.status.pan': '聲像',
  'eventList.global.filters': '全局事件篩選',
  ...
  'eventList.global.add.markerTitle': '在播放頭位置添加標記區段',
  'eventList.global.add.tempoTitle': '在播放頭位置添加速度區段',
  'eventList.global.add.keySignatureTitle': '在播放頭位置添加調號區段',
  'eventList.global.add.chordTitle': '在播放頭位置添加和弦區段',
  ...
  'toolbar.export.kgstudio': '導出為 KGStudio 文件',
  'toolbar.export.midi': '導出為 MIDI 文件',
  'toolbar.export.wav': '導出為 WAV',
  'toolbar.export.mp3': '導出為 MP3',
  'toolbar.projectName.prompt': '輸入項目名稱：',
  'toolbar.projectName.invalid': '無效的項目名稱。只允許字母、數字、空格、連字符、下劃線、句點和括號。',
  'toolbar.projectName.reserved': '"{name}" 是保留項目名稱。請選擇其他名稱。',
  'toolbar.projectName.overwrite': '項目 "{name}" 已存在。要覆蓋它嗎？',
  'toolbar.projectName.renameOrCopy': '你想重命名這個項目，還是另存為一個副本？',
  'toolbar.projectName.saveAsCopy': '另存為副本',
  'toolbar.projectName.rename': '重命名',
  'toolbar.save.error': '保存時發生錯誤：{error}',
  'toolbar.load.error': '加載項目時發生錯誤：{error}',
  'toolbar.newProject.confirm': '確定要創建新項目嗎？當前未保存的更改將會丟失。',
  'toolbar.project.notFound': '未找到項目 "{name}"。',
  'toolbar.openProject.confirm': '要打開這個項目嗎？當前項目中未保存的更改將會丟失。',
  'toolbar.status.loadFailed': '加載項目失敗：{error}',
  'toolbar.status.newProjectCreated': '已創建新項目 "{name}"',
  'toolbar.status.projectLoaded': '{description} 加載成功',
  'toolbar.status.projectExportedKgstudio': '項目 "{name}" 已導出為 KGStudio 文件',
  'toolbar.status.exportProjectError': '導出項目出錯：{error}',
  'toolbar.export.failedProject': '導出項目失敗：{error}',
  'toolbar.status.projectExportedMidi': '項目 "{name}" 已導出為 MIDI 文件',
  'toolbar.status.exportMidiError': '導出 MIDI 出錯：{error}',
  'toolbar.export.failedMidi': '導出項目為 MIDI 失敗：{error}',
  'toolbar.status.projectExportedWav': '項目 "{name}" 已導出為 WAV 文件',
  'toolbar.status.exportWavError': '導出 WAV 出錯：{error}',
  'toolbar.export.failedWav': '導出項目為 WAV 失敗：{error}',
  'toolbar.status.projectExportedMp3': '項目 "{name}" 已導出為 MP3 文件',
  'toolbar.status.exportMp3Error': '導出 MP3 出錯：{error}',
  'toolbar.export.failedMp3': '導出項目為 MP3 失敗：{error}',
  'toolbar.status.importFailed': '導入文件失敗：{error}',
  'toolbar.import.failedProjectFile': '導入項目文件失敗：{error}',
  'toolbar.import.corruptedKgstudio': '.kgstudio 文件已損壞或無效：{error}',
  'toolbar.status.importingMidi': '正在導入 MIDI 文件 "{name}"...',
  'toolbar.status.failedImportMidi': '導入 MIDI 文件失敗：{error}',
  ...
  'toolbar.timeSignature.prompt': '設置拍號：',
  'toolbar.status.timeSignatureChanged': '拍號已改為 {value}',
  'toolbar.status.keySignatureChanged': '調號已改為 {value}',
  'toolbar.status.copied': '項目已複製到剪貼板',
  'toolbar.status.copyNone': '沒有可複製的已選項目',
  'toolbar.status.pasted': '已從剪貼板粘貼項目',
  'toolbar.status.pasteFailed': '無法粘貼 - 沒有有效的剪貼板內容或上下文',
  'toolbar.status.deleted': '已刪除所選區域',
  'toolbar.status.deleteNone': '沒有選中可刪除的區域',
  ...
  'toolbar.action': '操作',
  'toolbar.status.chatToggled': '聊天窗口已切換',
  'toolbar.status.settingsToggled': '設置面板已切換',
  'toolbar.pianoRoll.selectMidiRegion': '請先選擇一個 MIDI 區域再打開鋼琴卷簾。',
  'toolbar.status.recordingStopped': '錄音已停止',
  'toolbar.status.audioRecordingStarted': '音頻錄音已開始...',
  'toolbar.recording.openMidiRegion': '開始錄音前，請先在鋼琴卷簾中打開一個 MIDI 區域。',
  'toolbar.recording.selectMidiRegion': '開始錄音前，請先選擇一個 MIDI 區域。',
  'toolbar.recording.noMidiDevice': '未檢測到 MIDI 設備。請連接 MIDI 鍵盤後重試。',
  'toolbar.status.recordingStarted': '錄音已開始...',
  'toolbar.button.new': '新建',
  'toolbar.button.load': '打開',
  'toolbar.button.save': '保存',
  'toolbar.button.export': '導出',
  'toolbar.button.import': '導入',
  'toolbar.button.settings': '設置',
  ...
  'toolbar.button.mergeRegions': '合併選中的 MIDI 區域',
  'toolbar.button.snapToGrid': '吸附到網格',
  'toolbar.button.copy': '複製',
  'toolbar.button.paste': '粘貼',
  ...
  'toolbar.export.label': '導出',
  'toolbar.importProject.title': '導入項目',
  'toolbar.importProject.description': '將項目文件拖放到這裡',
  'toolbar.openingProject': '正在打開項目...',
  'fileImport.invalidType': '文件類型無效。請選擇以下擴展名之一的文件：{extensions}',
  'fileImport.close': '關閉導入彈窗',
  'fileImport.supportedFormats': '支持的格式：{formats}',
  'fileImport.or': '或',
  'fileImport.browse': '瀏覽文件',
  ...
  'kgone.tab.requiresServer': '需要 K.G.One Music Studio 服務器集成',
  // Shared across tabs
  'kgone.shared.advancedSettings': '高級設置',
  ...
  'kgone.shared.poweredBy': '技術支持：',
  'kgone.shared.btn.loadingModel': '加載模型中...',
  ...
  'kgone.shared.btn.importing': '導入中...',
  'kgone.shared.hint.loadingModel': '正在加載模型——此過程可能需要 60 秒以上，請耐心等待...',
  'kgone.shared.hint.submitting': '正在提交生成請求...',
  'kgone.shared.hint.downloadingAudio': '正在下載音頻...',
  // Clip tab
  ...
  'kgone.clip.hint.drag': '將上方播放器拖至音軌以導入片段。拖到<strong>音頻音軌</strong>可作為 WAV 區域導入（推薦），拖到<strong>MIDI 音軌</strong>可作為 MIDI 區域導入。注意：MIDI 是從音頻轉錄的，可能不完全準確。',
  ...
  'kgone.fullSong.hint.drag': '將上方播放器拖至<strong>音頻音軌</strong>以導入歌曲。完整歌曲生成不支持拖至 MIDI 音軌。',
  ...
  'kgone.remix.hint.drag': '將上方播放器拖至<strong>音頻音軌</strong>以導入混音。',
  'kgone.remix.hint.noRegion': '請在時間軸上選擇一個音頻區域以進行混音。僅支持音頻區域——MIDI 區域不可混音。',
  'kgone.remix.btn.generate': '生成混音',
  'kgone.remix.btn.processingRemix': '處理混音中...',
  'kgone.remix.btn.importAligned': '對齊源區域並導入',
  'kgone.remix.poweredBy': 'ACE-Step 1.5',
  // Repaint tab
  'kgone.repaint.field.repaintRange': '重繪範圍',
  'kgone.repaint.field.loopModeOff': '循環模式已關閉。請啟用工具欄上的循環按鈕並設置循環範圍以定義重繪窗口。',
  'kgone.repaint.field.start': '開始',
  'kgone.repaint.field.end': '結束',
  'kgone.repaint.field.untilEnd': '直至音頻末尾',
  ...
  'kgone.repaint.hint.drag': '將上方播放器拖至<strong>音頻音軌</strong>以導入重繪結果。',
  'kgone.repaint.hint.noRegion': '請在時間軸上選擇一個音頻區域以進行重繪。僅支持音頻區域——MIDI 區域不可重繪。',
  'kgone.repaint.btn.generate': '生成重繪',
  'kgone.repaint.btn.processingRepaint': '處理重繪中...',
  'kgone.repaint.btn.importAligned': '對齊源區域並導入',
  'kgone.repaint.poweredBy': 'ACE-Step 1.5',
  // Separator tab
  'kgone.separator.field.separationModel': '分離模型',
  'kgone.separator.field.chunkDuration': '可選音頻分塊時長（秒）',
  'kgone.separator.field.chunkDurationPlaceholder': '留空則處理整個區域',
  'kgone.separator.field.modelOverlap': '模型重疊',
  'kgone.separator.hint.drag': '將上方各音軌播放器拖至<strong>音頻音軌</strong>以導入。不支持拖至 MIDI 音軌進行音軌分離。',
  'kgone.separator.hint.noRegion.download': '請下載 {model}，然後在時間軸上選擇一個音頻區域以提取音軌。',
  'kgone.separator.hint.noRegion.select': '請在時間軸上選擇一個音頻區域以提取音軌。僅支持音頻區域——MIDI 區域不可分離。',
  'kgone.separator.btn.separateStems': '分離音軌',
  'kgone.separator.btn.importAllStems': '將所有音軌導入時間軸',
  ...
  'kgone.separator.btn.server.loadingModel': '加載模型中...',
  ...
  'kgone.separator.btn.local.generating': '準備音頻...',
  'kgone.separator.btn.local.polling': '本地分離中...',
  'kgone.separator.btn.local.downloading': '收尾處理...',
  'kgone.separator.local.title': '本地分離模式',
  'kgone.separator.local.description': '如果 K.G.One Music Studio 不可用，本地分離模式提供了一種直接在瀏覽器中提取音軌的內置替代方案。提供兩種本地模型：人聲與樂器（中等精度），以及人聲、鼓、貝斯及其他。下方的下載狀態反映當前選定的模型。人聲與樂器（中等精度）的處理時間通常比人聲、鼓、貝斯及其他更長，總處理時間仍取決於您的硬件配置。如果處理回退至 CPU，分離運行期間頁面響應可能暫時變慢。',
  'kgone.separator.local.learnMore': '了解更多關於 K.G.One Music Studio 服務器集成的信息。',
  'kgone.separator.local.provider': '當前設備：',
  ...
  'kgone.separator.local.progress.readingAudio': '正在讀取音頻文件...',
  'kgone.separator.local.progress.running': '正在瀏覽器中執行分離...',
  'kgone.separator.local.progress.complete': '分離完成。',

  'openProjectModal.title': '打開項目',
  'openProjectModal.close': '關閉',
  'openProjectModal.loading': '正在加載項目...',
  'openProjectModal.date.unknown': '未知',
  'openProjectModal.filter.placeholder': '篩選項目...',
  'openProjectModal.viewToggle.projects': '項目',
  'openProjectModal.viewToggle.trash': '回收站',
  'openProjectModal.trash.hint': '已刪除的項目將在 30 天後自動移除。',
  'openProjectModal.sort.name': '名稱',
  'openProjectModal.sort.created': '創建時間',
  'openProjectModal.sort.updated': '更新時間',
  'openProjectModal.empty.trash': '回收站為空',
  'openProjectModal.empty.noProjects': '暫無已保存的項目',
  'openProjectModal.empty.noMatch': '沒有符合篩選條件的項目',
  'openProjectModal.meta.created': '創建於 {date}',
  'openProjectModal.meta.updated': '更新於 {date}',
  'openProjectModal.meta.deleted': '刪除於 {date}',
  'openProjectModal.action.open': '打開',
  'openProjectModal.action.duplicate': '複製',
  'openProjectModal.action.delete': '刪除',
  'openProjectModal.action.restore': '恢復',
  'openProjectModal.action.deletePermanently': '永久刪除',
  'openProjectModal.dialog.duplicateName': '請輸入複製項目的名稱：',
  'openProjectModal.dialog.invalidName': '項目名稱無效。只允許使用字母、數字、空格、連字符、下劃線、句號和括號。',
  'openProjectModal.dialog.duplicateError': '複製項目失敗：{error}',
  'openProjectModal.dialog.deleteError': '刪除項目失敗：{error}',
  'openProjectModal.dialog.restoreError': '恢復項目失敗：{error}',
  'openProjectModal.dialog.confirmPermanentDelete': '確定要永久刪除"{name}"嗎？\n\n此操作無法撤銷。',
  'openProjectModal.dialog.permanentDeleteError': '永久刪除項目失敗：{error}',
};
