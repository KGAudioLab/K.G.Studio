...
export const zhCnMessages: TranslationMessages = {
  ...
  'dialog.title.convertChordsToMidi': '将和弦转换为 MIDI',
  'dialog.chordToMidi.methodLabel': '和弦转 MIDI 的转换方式',
  'dialog.chordToMidi.createRegion': '创建新的 MIDI 片段',
  'dialog.chordToMidi.addToRegion': '将音符添加到现有片段',
  'dialog.chordToMidi.replaceInRegion': '替换现有片段中的音符',
  ...
  'toolbar.snap.off': '关闭',
  'toolbar.snap.bar': '吸附到小节',
  'toolbar.snap.beat': '吸附到节拍',
  ...
  'track.duplicate.menuItem': '复制轨道...',
  'track.duplicate.title': '复制轨道',
  'track.duplicate.message': '请选择要包含在复制轨道中的内容。',
  'track.duplicate.trackSettings': '轨道设置',
  'track.duplicate.automation': '自动化',
  'track.duplicate.regions': '区域',
  'track.duplicate.noRegions': '此轨道没有区域。',
  'track.duplicate.cancel': '取消',
  'track.duplicate.confirm': '复制',
  'track.duplicate.status': '已复制轨道“{name}”',
  'track.duplicate.error': '无法复制轨道。请重试。',
  ...
  'transpose.menuItem': '移调设置…',
  'transpose.title': '移调设置',
  'transpose.inheritTrack': '继承轨道设置',
  'transpose.followKeySignature': '跟随调号',
  'transpose.transpose': '移调',
  'transpose.noTranspose': '不移调',
  'transpose.ok': '确定',
  'transpose.cancel': '取消',
  'transpose.status.trackUpdated': '轨道移调设置已更新',
  'transpose.status.regionUpdated': '片段移调设置已更新',
  'transpose.error': '无法应用移调设置：{error}',
  'transpose.chords.confirmRange': '受影响的范围内包含和弦。是否将这些和弦自动移调到新调性？',
  'transpose.chords.confirmProject': '全局和弦轨不为空。是否将所有和弦自动移调到新的项目调性？',
  'transpose.chords.transposeAction': '移调',
  'transpose.chords.leaveAction': '保持不变',
};
