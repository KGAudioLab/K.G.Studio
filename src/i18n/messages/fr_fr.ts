...
export const frFrMessages: TranslationMessages = {
  ...
  'dialog.title.convertChordsToMidi': 'Convertir les accords en MIDI',
  'dialog.chordToMidi.methodLabel': 'Méthode de conversion des accords en MIDI',
  'dialog.chordToMidi.createRegion': 'Créer une nouvelle région MIDI',
  'dialog.chordToMidi.addToRegion': 'Ajouter les notes à la région existante',
  'dialog.chordToMidi.replaceInRegion': 'Remplacer les notes dans la région existante',
  ...
  'dialog.title.selectNoteByRank': 'Sélectionner une note par rang',
  ...
  'dialog.label.noteRankDirection': 'Direction',
  'dialog.label.noteRank': 'Rang',
  'dialog.label.noteRankInterval': 'Intervalle de détection',
  'dialog.label.noteRankRange': 'Plage de sélection',
  'dialog.option.bottomToTop': 'Du bas vers le haut',
  'dialog.option.topToBottom': 'Du haut vers le bas',
  'dialog.option.noteRankSelectedOnly': 'Rang sélectionné uniquement',
  'dialog.option.noteRankSelectedAndAbove': 'Rang sélectionné et au-dessus',
  'dialog.option.noteRankSelectedAndBelow': 'Rang sélectionné et au-dessous',
  'dialog.to': 'à',
  ...
  'pianoRoll.selectNoteByRank': 'Sélectionner une note par rang…',
  'pianoRoll.exportMidi': 'Exporter en MIDI',
  'pianoRoll.status.regionExportedMidi': 'Région « {name} » exportée au format MIDI',
  'pianoRoll.status.exportMidiError': 'Erreur lors de l\'export MIDI : {error}',
  'pianoRoll.export.failedMidi': 'Échec de l\'export de la région au format MIDI : {error}',
  ...
  'toolbar.snap.off': 'Désactivé',
  'toolbar.snap.bar': 'Aligner à la mesure',
  'toolbar.snap.beat': 'Aligner au temps',
  ...
  'track.controls.exportMidi': 'Exporter en MIDI',
  'track.controls.status.trackExportedMidi': 'Piste « {name} » exportée au format MIDI',
  'track.controls.status.exportMidiError': 'Erreur lors de l\'export MIDI : {error}',
  'track.controls.export.failedMidi': 'Échec de l\'export de la piste au format MIDI : {error}',
  ...
  'track.duplicate.menuItem': 'Dupliquer la piste...',
  'track.duplicate.title': 'Dupliquer la piste',
  'track.duplicate.message': 'Choisissez les éléments à inclure dans la piste dupliquée.',
  'track.duplicate.trackSettings': 'Réglages de la piste',
  'track.duplicate.automation': 'Automatisation',
  'track.duplicate.regions': 'Régions',
  'track.duplicate.noRegions': 'Cette piste ne contient aucune région.',
  'track.duplicate.cancel': 'Annuler',
  'track.duplicate.confirm': 'Dupliquer',
  'track.duplicate.status': 'Piste « {name} » dupliquée',
  'track.duplicate.error': 'Impossible de dupliquer la piste. Veuillez réessayer.',
  ...
  'instrument.group.CUSTOM': 'Instruments personnalisés',
  'userInstrument.manage': 'Gérer les instruments…',
  'userInstrument.title': 'Instruments personnalisés',
  'userInstrument.close': 'Fermer le gestionnaire d’instruments',
  'userInstrument.add': 'Ajouter un instrument…',
  'userInstrument.delete': 'Supprimer',
  'userInstrument.deleteInstrument': 'Supprimer l’instrument',
  'userInstrument.status.enabled': 'Activé',
  'userInstrument.status.disabled': 'Désactivé',
  'userInstrument.field.name': 'Nom',
  'userInstrument.field.lowerPitch': 'Note la plus grave',
  'userInstrument.field.upperPitch': 'Note la plus aiguë',
  'userInstrument.field.image': 'Image',
  'userInstrument.field.fallback': 'Instrument intégré de secours',
  'userInstrument.field.enabled': 'Activé',
  'userInstrument.field.percussion': 'Utiliser l’affichage des percussions',
  'userInstrument.table.pitch': 'Note',
  'userInstrument.table.soundFile': 'Fichier audio',
  'userInstrument.uploadSound': 'Importer un son',
  'userInstrument.empty': 'Ajoutez un instrument pour commencer.',
  'userInstrument.sampleHint': 'Sélectionnez « Importer un son » ou déposez un fichier WAV ou MP3 sur une ligne pour affecter un échantillon à la note correspondante. Il n’est pas nécessaire de fournir chaque note, mais au moins un échantillon est requis pour activer l’instrument. Pour un résultat plus naturel sur toute l’étendue, ajoutez des échantillons à plusieurs notes bien réparties.',
  'userInstrument.prompt.name': 'Saisissez le nom du nouvel instrument :',
  'userInstrument.error.invalidName': 'Nom d’instrument invalide. Utilisez uniquement des lettres, des chiffres, des espaces, des tirets, des underscores, des points ou des parenthèses.',
  'userInstrument.error.unsupportedFile': 'Seuls les fichiers WAV et MP3 sont pris en charge.',
  'userInstrument.error.decode': 'Le fichier audio sélectionné n’a pas pu être décodé.',
  'userInstrument.error.preview': 'Le son sélectionné n’a pas pu être écouté.',
  'userInstrument.error.reload': 'Certains instruments modifiés n’ont pas pu être rechargés. Leurs instruments de secours configurés seront utilisés.',
  'userInstrument.error.sampleRequired': 'Ajoutez au moins un échantillon dans l’étendue sélectionnée avant d’activer cet instrument.',
  'userInstrument.error.update': 'Les réglages de l’instrument n’ont pas pu être mis à jour. Vérifiez les valeurs sélectionnées, puis réessayez.',
  'userInstrument.confirm.replaceSample': 'Remplacer « {file} » pour la note {pitch} ?',
  'userInstrument.confirm.deleteSample': 'Supprimer le son affecté à la note {pitch} ?',
  'userInstrument.confirm.deleteInstrument': 'Supprimer « {name} » ?',
  'userInstrument.confirm.deleteDetail': '{tracks} piste(s) du projet actuel et {projects} projet(s) enregistré(s) font référence à cet instrument. Ces références seront conservées et utiliseront le piano à queue acoustique.',
  'userInstrument.preview.play': 'Écouter le son',
  'userInstrument.preview.stop': 'Arrêter l’écoute',
  'userInstrument.preview.playAria': 'Écouter {file}',
  'userInstrument.preview.stopAria': 'Arrêter l’écoute de {file}',
  'userInstrument.missingWarning': 'Ce projet fait référence à des instruments personnalisés qui ne sont pas installés dans cet environnement :\n\n{instruments}\n\nLe piano à queue acoustique sera utilisé comme instrument de secours.',
  ...
  'transpose.menuItem': 'Réglages de transposition…',
  'transpose.title': 'Réglages de transposition',
  'transpose.inheritTrack': 'Hériter des réglages de la piste',
  'transpose.followKeySignature': 'Suivre l\'armure',
  'transpose.transpose': 'Transposition',
  'transpose.noTranspose': 'Ne pas transposer',
  'transpose.ok': 'OK',
  'transpose.cancel': 'Annuler',
  'transpose.status.trackUpdated': 'Réglages de transposition de la piste mis à jour',
  'transpose.status.regionUpdated': 'Réglages de transposition de la région mis à jour',
  'transpose.error': 'Impossible d\'appliquer la transposition : {error}',
  'transpose.chords.confirmRange': 'La plage concernée contient des accords. Transposer ces accords dans la nouvelle tonalité ?',
  'transpose.chords.confirmProject': 'La piste d’accords globale n’est pas vide. Transposer tous les accords dans la nouvelle tonalité du projet ?',
  'transpose.chords.transposeAction': 'Transposer',
  'transpose.chords.leaveAction': 'Laisser inchangé',
};
