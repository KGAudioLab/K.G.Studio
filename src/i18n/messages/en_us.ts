...
export const enUsMessages: TranslationMessages = {
  ...
  'dialog.title.convertChordsToMidi': 'Convert Chords to MIDI',
  'dialog.chordToMidi.methodLabel': 'Chord-to-MIDI conversion method',
  'dialog.chordToMidi.createRegion': 'Create a New MIDI Region',
  'dialog.chordToMidi.addToRegion': 'Add Notes to the Existing Region',
  'dialog.chordToMidi.replaceInRegion': 'Replace Notes in the Existing Region',
  ...
  'dialog.title.selectNoteByRank': 'Select Note by Rank',
  ...
  'dialog.label.noteRank': 'Rank',
  'dialog.label.noteRankInterval': 'Detection interval',
  'dialog.label.noteRankRange': 'Selection range',
  'dialog.option.bottomToTop': 'Bottom to top',
  'dialog.option.topToBottom': 'Top to bottom',
  'dialog.option.noteRankSelectedOnly': 'Selected rank only',
  'dialog.option.noteRankSelectedAndAbove': 'Selected rank and above',
  'dialog.option.noteRankSelectedAndBelow': 'Selected rank and below',
  'dialog.to': 'to',
  ...
  'pianoRoll.selectNoteByRank': 'Select Note by Rank…',
  'pianoRoll.exportMidi': 'Export MIDI',
  'pianoRoll.status.regionExportedMidi': 'Region "{name}" exported as MIDI file',
  'pianoRoll.status.exportMidiError': 'Error exporting MIDI: {error}',
  'pianoRoll.export.failedMidi': 'Failed to export region as MIDI: {error}',
  ...
  'regionPaste.error.selectTrack': 'Please select a track before pasting these regions.',
  'regionPaste.error.originalTracksMissing': 'Some of the original tracks are no longer available, so these regions couldn\u2019t be pasted. Please copy the regions again and try once more.',
  'regionPaste.error.selectedTrackMissing': 'The selected track is no longer available. Please select another track and try again.',
  'regionPaste.error.noRegions': 'There are no regions available to paste.',
  'regionPaste.error.generic': 'Unable to paste these regions. Please try again.',
  'regionPaste.description.originalTracks': 'Paste {count} regions to their original tracks',
  ...
  'toolbar.snap.off': 'Off',
  'toolbar.snap.bar': 'Snap to Bar',
  'toolbar.snap.beat': 'Snap to Beat',
  ...
  'track.controls.exportMidi': 'Export MIDI',
  'track.controls.status.trackExportedMidi': 'Track "{name}" exported as MIDI file',
  'track.controls.status.exportMidiError': 'Error exporting MIDI: {error}',
  'track.controls.export.failedMidi': 'Failed to export track as MIDI: {error}',
  ...
  'track.duplicate.menuItem': 'Duplicate Track...',
  'track.duplicate.title': 'Duplicate Track',
  'track.duplicate.message': 'Choose what you\u2019d like to include in the duplicated track.',
  'track.duplicate.trackSettings': 'Track Settings',
  'track.duplicate.automation': 'Automation',
  'track.duplicate.regions': 'Regions',
  'track.duplicate.noRegions': 'This track has no regions.',
  'track.duplicate.cancel': 'Cancel',
  'track.duplicate.confirm': 'Duplicate',
  'track.duplicate.status': 'Duplicated track "{name}"',
  'track.duplicate.error': 'Unable to duplicate the track. Please try again.',
  ...
  'instrument.group.CUSTOM': 'Custom Instruments',
  'userInstrument.manage': 'Manage Instruments…',
  'userInstrument.title': 'Custom Instruments',
  'userInstrument.close': 'Close instrument manager',
  'userInstrument.add': 'Add Instrument…',
  'userInstrument.delete': 'Delete',
  'userInstrument.deleteInstrument': 'Delete Instrument',
  'userInstrument.status.enabled': 'Enabled',
  'userInstrument.status.disabled': 'Disabled',
  'userInstrument.field.name': 'Name',
  'userInstrument.field.lowerPitch': 'Lower pitch',
  'userInstrument.field.upperPitch': 'Upper pitch',
  'userInstrument.field.image': 'Image',
  'userInstrument.field.fallback': 'Built-in fallback',
  'userInstrument.field.enabled': 'Enabled',
  'userInstrument.field.percussion': 'Use percussion display',
  'userInstrument.table.pitch': 'Pitch',
  'userInstrument.table.soundFile': 'Sound file',
  'userInstrument.uploadSound': 'Upload Sound',
  'userInstrument.empty': 'Add an instrument to get started.',
  'userInstrument.sampleHint': 'Select “Upload Sound” or drop a WAV or MP3 file onto a pitch row to assign its sample. You do not need to provide every pitch, but at least one sample is required to enable the instrument. For more natural results across the full range, add samples at several well-spaced pitches.',
  'userInstrument.prompt.name': 'Enter a name for the new instrument:',
  'userInstrument.error.invalidName': 'Invalid instrument name. Use letters, numbers, spaces, hyphens, underscores, periods, or parentheses.',
  'userInstrument.error.unsupportedFile': 'Only WAV and MP3 files are supported.',
  'userInstrument.error.decode': 'The selected audio file could not be decoded.',
  'userInstrument.error.preview': 'The selected sound could not be previewed.',
  'userInstrument.error.reload': 'Some edited instruments could not be reloaded. Their configured fallback instruments will be used.',
  'userInstrument.error.sampleRequired': 'Add at least one sample within the selected pitch range before enabling this instrument.',
  'userInstrument.error.update': 'The instrument settings could not be updated. Please review the selected values and try again.',
  'userInstrument.confirm.replaceSample': 'Replace “{file}” at {pitch}?',
  'userInstrument.confirm.deleteSample': 'Delete the sound assigned to {pitch}?',
  'userInstrument.confirm.deleteInstrument': 'Delete “{name}”?',
  'userInstrument.confirm.deleteDetail': '{tracks} track(s) in the current project and {projects} saved project(s) reference this instrument. Those references will be preserved and will use Acoustic Grand Piano.',
  'userInstrument.preview.play': 'Preview sound',
  'userInstrument.preview.stop': 'Stop preview',
  'userInstrument.preview.playAria': 'Preview {file}',
  'userInstrument.preview.stopAria': 'Stop previewing {file}',
  'userInstrument.missingWarning': 'This project references custom instruments that are not installed in this environment:\n\n{instruments}\n\nAcoustic Grand Piano will be used as the fallback.',
  ...
  'transpose.menuItem': 'Transpose settings...',
  'transpose.title': 'Transpose Settings',
  'transpose.inheritTrack': 'Inherit track settings',
  'transpose.followKeySignature': 'Follow key signature',
  'transpose.transpose': 'Transpose',
  'transpose.noTranspose': 'No transpose',
  'transpose.ok': 'OK',
  'transpose.cancel': 'Cancel',
  'transpose.status.trackUpdated': 'Track transpose settings updated',
  'transpose.status.regionUpdated': 'Region transpose settings updated',
  'transpose.error': 'Could not apply transpose settings: {error}',
  'transpose.chords.confirmRange': 'The affected range contains chords. Transpose those chords to the new key?',
  'transpose.chords.confirmProject': 'The global chord track is not empty. Transpose all chords to the new project key?',
  'transpose.chords.transposeAction': 'Transpose',
  'transpose.chords.leaveAction': 'Leave unchanged',
};
